...
/**
 * 用法同UnsafeByteArrayOutputStream，非线程安全，只能用在同一线程中
 * 
 *
 */
...
public class UnsafeByteArrayOutputStream extends OutputStream {
	 ...
	 *
	 * @see java.io.UnsafeByteArrayInputStream#count
	 */
	public void reset() {
		count = 0;
	}
	 ...
	 * @see java.io.UnsafeByteArrayOutputStream#size()
	 */
	 ...
	 * @see java.io.UnsafeByteArrayOutputStream#count
	 */
	public int size() {
		return count;
	}
	...
	/**
	 * Closing a <tt>UnsafeByteArrayOutputStream</tt> has no effect. The methods
