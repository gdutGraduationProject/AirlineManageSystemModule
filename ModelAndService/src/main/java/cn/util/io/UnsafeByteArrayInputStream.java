...
/**
 * 用法同UnsafeByteArrayInputStream，非线程安全
 * 
 *
 */
public class UnsafeByteArrayInputStream extends InputStream {
	...
	/**
	 * The currently marked position in the stream. UnsafeByteArrayInputStream
	...
	/**
	 * Creates a <code>UnsafeByteArrayInputStream</code> so that it uses
	...
	/**
	 * Creates <code>UnsafeByteArrayInputStream</code> that uses
	 ...
	 * <code>buf.length</code>. The buffer array is not copied. The buffer's
	 ...
	 * <code>UnsafeByteArrayInputStream</code> always returns <code>true</code>.
	 *
	 * @since JDK1.1
	 */
	...
	/**
	 * Set the current marked position in the stream. UnsafeByteArrayInputStream
	 * objects are marked at position zero by default when constructed. They may
	...
	/**
	 * Closing a <tt>UnsafeByteArrayInputStream</tt> has no effect. The methods
