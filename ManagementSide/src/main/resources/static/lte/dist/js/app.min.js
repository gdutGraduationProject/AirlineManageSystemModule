 ...
 */
$(function(){
    $("#top-sidebar-toggle").on('click',function(){
        if($("body.sidebar-collapse").length==1){
            window.sessionStorage.setItem("top-menu-close",'false')
        }else{
            window.sessionStorage.setItem("top-menu-close",'true')
        }
    })
})
console.log(window.sessionStorage.getItem("top-menu-close"))
if(window.sessionStorage.getItem("top-menu-close")=='true'){
    console.log("xxx"+$("body").length)
