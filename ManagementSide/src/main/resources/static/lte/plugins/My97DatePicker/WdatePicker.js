...
(function () {
    ...
    function I(G, _) {
        ...
        function E(K, J) {
            var I = V[N].domain, F = false, G = "<iframe id=dataIframe  hideFocus=true width=9 height=7 frameborder=0 border=0 scrolling=no src=\"about:blank\"></iframe>";
            K.innerHTML = G;
